...
parser.add_argument('--epochs_numbers', type=int, default=249, help='maximum epoch number to train')
...
parser.add_argument('--output_dir', type=str, default='checkpoint_all/checkpoint_ortonb3_epoch250',help='output dir')
...
if __name__ == "__main__":
    ...
    weight_CNN_D = os.path.join('checkpoint/CNN_with_Swin_E_CNN_D', 'epoch_'+str(249)+'.pth')
    msg = net.load_state_dict(torch.load(weight_CNN_D))
    print("self trained swin unet",msg)
    weight_Swin_D = os.path.join('checkpoint/CNN_with_Swin_E_Swin_D', 'epoch_'+str(249)+'.pth')
    msg2 = net2.load_state_dict(torch.load(weight_Swin_D))
    print("self trained swin unet",msg2)
